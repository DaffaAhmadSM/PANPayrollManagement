    ...
    public function view(): View
    {
        try {
            ...
            $output = $data
                ...
                ->map(function ($byKronos) use (
                    &$holiday,
                    &$employee_rate_details,
                    &$employee_department
                ) {
                    $total = [
                        "paid_hours_total" => 0,
                        ...
                        ->map(function ($byOracle) use (
                            ...
                            return $byOracle
                                ->map(function ($byEmployee) use (
                                    ...
                                    $byEmployee->each(function (
                                        $employeeData
                                    ) use (&$result, &$holiday, &$total) {
                                        $is_holiday = false;
